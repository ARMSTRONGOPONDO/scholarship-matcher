...
class Resource(models.Model):
    ...
    url = models.URLField(blank=True, null=True, help_text="URL for external content (videos, podcasts, etc.)")
    author = models.CharField(max_length=200, blank=True, help_text="Author or creator name")
    content_type = models.CharField(max_length=50, blank=True, help_text="MIME type or content type")
