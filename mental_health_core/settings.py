...
ROOT_URLCONF = 'mental_health_core.urls'
...
WSGI_APPLICATION = 'mental_health_core.wsgi.application'
...
PODCAST_INDEX_API = {
    'API_KEY': env('PODCAST_INDEX_API_KEY', default=''),
    'API_SECRET': env('PODCAST_INDEX_API_SECRET', default=''),
    'USER_AGENT': 'MindfulSpaceMentalHealthPlatform/1.0'
}